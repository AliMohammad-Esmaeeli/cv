...
export default function BlogIndex() {
  ...
  return (
    <div className="max-w-3xl px-3 py-12 min-h-dvh scroll-smooth overflow-x-hidden select-none appearance-none font-yekanBakh bg-white text-black dark:bg-stone-950 dark:text-white">
