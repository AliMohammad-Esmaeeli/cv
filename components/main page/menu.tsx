...
export default function Menu(props: propstype) {
  ...
  return (
    <div>
      <div
        id="skills"
        className="grid grid-cols-2 md:grid-cols-4 place-items-center"
      >
        <Tilt options={defaultOptions}>
          <div className="bg-red-400 w-44 h-44 rounded-3xl shadow-2xl p-10 m-5 flex justify-center items-center">
            <svg
              className="h-28 w-28"
        ...
        <Tilt options={defaultOptions}>
          <div className="bg-blue-400 w-44 h-44 rounded-3xl shadow-2xl p-10 m-5 flex justify-center items-center">
            <svg
              className="w-28 h-28"
              xmlns="http://www.w3.org/2000/svg"
              width="512"
        ...
        <Tilt options={defaultOptions}>
          <div className="bg-orange-400 w-44 h-44 rounded-3xl shadow-2xl p-10 m-5 flex justify-center items-center">
            <svg
        ...
        <Tilt options={defaultOptions}>
          <div className="bg-indigo-400 w-44 h-44 rounded-3xl shadow-2xl p-10 m-5 flex justify-center items-center">
            <svg
              className="w-28 h-28 rounded-2xl"
              fill="none"
              height="512"
        ...
        <Tilt options={defaultOptions}>
          <div className="bg-purple-400 w-44 h-44 rounded-3xl shadow-2xl p-10 m-5 flex justify-center items-center">
            <Image
              src="/bootstrap.png"
              height={100}
              width={100}
        ...
        <Tilt options={defaultOptions}>
          <div className="bg-purple-950 w-44 h-44 rounded-3xl shadow-2xl p-10 m-5 flex justify-center items-center">
            <svg
              className="w-28 h-28 "
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
        ...
        <Tilt options={defaultOptions}>
          <div className="bg-green-400 w-44 h-44 rounded-3xl shadow-2xl p-10 m-5 flex justify-center items-center">
            <svg
              width="100%"
              height="100%"
        ...
        <Tilt options={defaultOptions}>
          <div className="bg-violet-400 w-44 h-44 rounded-3xl shadow-2xl p-10 m-5 flex justify-center items-center">
            <svg
        ...
        <Tilt options={defaultOptions}>
          <div className="bg-fuchsia-400 w-44 h-44 rounded-3xl shadow-2xl p-10 m-5 flex justify-center items-center">
            <svg
              width="410"
              height="404"
              viewBox="0 0 410 404"
        ...
        <Tilt options={defaultOptions}>
          <div className="bg-blue-900 w-44 h-44 rounded-3xl shadow-2xl p-10 m-5 flex justify-cnter items-center">
            <Image
              className="h-28 w-28"
              height={100}
              width={100}
        ...
        <Tilt options={defaultOptions}>
          <div className="bg-yellow-400 w-44 h-44 rounded-3xl shadow-2xl p-10 m-5 flex justify-center items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
        ...
        <Tilt options={defaultOptions}>
          <div className="bg-emerald-400 w-44 h-44 rounded-3xl shadow-2xl p-10 m-5">
