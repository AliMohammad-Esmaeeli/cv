...
export default function ShareButton(props: PropsType) {
    ...
    return (
        <Button
            className="w-full h-14 mt-6 bg-indigo-600 py-2 px-4 rounded-md hover:bg-indigo-700 transition-colors flex justify-center items-center gap-2 flex-row-reverse"
            onClick={() => {
                navigator.share({
